package com.example.ServiceTaskManagementSystem.Repository;
...
public interface TaskRepository extends JpaRepository<Task, Long> {
    ...
    @Query("SELECT new com.example.ServiceTaskManagementSystem.dto.StatusCountDTO(t.status, COUNT(t)) FROM Task t GROUP BY t.status")
